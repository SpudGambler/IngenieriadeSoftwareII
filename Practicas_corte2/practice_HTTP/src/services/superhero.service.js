...
class SuperheroService {
  ...
  async editSuperhero(superheroId, superhero, real_name, feature, superhero_sidekick) {
    return SuperheroModel.findByIdAndUpdate({ _id: superheroId }, {superhero, real_name, feature, superhero_sidekick}).then(
      (superheroFind) => {
